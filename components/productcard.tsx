  ...
  return (
    <div className="card flex flex-col max-w-[250px] items-center gap-1 flex-grow m-auto mb-4">
      <div className="image w-full h-full overflow-hidden">
        <Image src={'https://unsplash.it/200/300'} priority={true} width={200} height={300} alt='product image' className="hover:scale-110 hover:opacity-75 transition-all cursor-pointer rounded-md"/>
      </div>
